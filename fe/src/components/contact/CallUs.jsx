    ...
    <div className="contatti-page">
      <Container>
        <Row>
          <Col md={6}>
            ...
            <Form onSubmit={handleSubmit}>
              ...
              <Form.Group controlId="formMessaggio">
                <Form.Label  className='fw-bold mt-3'>Messaggio</Form.Label>
          ...
          <Col md={6}>
            <Image className='mt-5' src="https://cdn2.hubspot.net/hubfs/1982274/Blog/Rispondere%20al%20telefono%20in%20inglese.jpg" alt="Contatti" fluid />
          </Col>
        </Row>
      </Container>
    </div>
